...
class TestEmotionDetector(unittest.TestCase):
    def test_emotion_detector(self):
        ...
        result_2 = emotion_detector("I am really afraid that this will happen")
        ...
        result_5 = emotion_detector("I am glad this happened")
        self.assertEqual(result_5['dominant_emotion'], 'joy')
